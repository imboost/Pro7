...
blockManager.add('table_pagination_footer', {
    label: 'Pagination',
    attributes: {
        class: 'fa fa-square',
...
blockManager.add('table_checkbox', {
    label: 'Checkbox',
    attributes: {
        class: 'fa fa-square',
        title: 'Table With Checkbox'
    },
    content: '<div class="data-table data-table-init">' +
        '  <table>' +
        '    <thead>' +
        '      <tr>' +
...
blockManager.add('table_header_row_actions', {
...
blockManager.add('table_sortable', {
    label: 'Sortable',
    attributes: {
        class: 'fa fa-square',
...
blockManager.add('table_collapsible', {
    label: 'Collapsible',
    attributes: {
        class: 'fa fa-square',
        title: 'Table With Collapsible'
    },
    content: '<div class="data-table data-table-collapsible data-table-init">' +
        '  <div class="card-header">' +
        '    <div class="data-table-title">Nutrition</div>' +
        '    <div class="data-table-actions">' +
        '      <a class="link icon-only">' +
